package com.megacorp.humanresources.advisors;
...
@Component
public class ChatClientLoggingAdvisor implements CallAdvisor, StreamAdvisor {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ChatClientLoggingAdvisor.class);
    private final Function<ChatClientRequest, String> requestToString;
    private final Function<ChatResponse, String> responseToString;
    private final int order;

    public ChatClientLoggingAdvisor() {
        this(DEFAULT_REQUEST_TO_STRING, DEFAULT_RESPONSE_TO_STRING, 0);
    }

    public ChatClientLoggingAdvisor(int order) {
        this(DEFAULT_REQUEST_TO_STRING, DEFAULT_RESPONSE_TO_STRING, order);
    }

    public ChatClientLoggingAdvisor(@Nullable Function<ChatClientRequest, String> requestToString, @Nullable Function<ChatResponse, String> responseToString, int order) {
